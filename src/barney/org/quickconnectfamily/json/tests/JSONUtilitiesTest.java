...
package barney.org.quickconnectfamily.json.tests;
/*
 * Since JSONUtilities methods use the JSONInput and JSONOutput streams this test class
 * tests those classes as well as the JSONUtilities class
 */
...
public class JSONUtilitiesTest {
	...
	public void testStringifySerializable() {
		 ...
		 */
		org.quickconnectfamily.json.tests.TestObject anObject = new org.quickconnectfamily.json.tests.TestObject("Hello there.", 7, new Date(1067899));
		try {
    ...
    /*
		 ...
		 */
		org.quickconnectfamily.json.tests.TestObject aNullObject = new org.quickconnectfamily.json.tests.TestObject();
		try {
		 ...
		 */
		org.quickconnectfamily.json.tests.TestObject anObjectWithNull = new org.quickconnectfamily.json.tests.TestObject(null, 7, new Date(1067899));
		try {
		...
		org.quickconnectfamily.json.tests.TestObject anObjectWithEscapedString = new org.quickconnectfamily.json.tests.TestObject(stringWithEscapes, 7, new Date(1067899));
		try {
	...
	public void testStringifyParse(){
		Date testDate = new Date(1067899);
		org.quickconnectfamily.json.tests.TestObject anObject = new org.quickconnectfamily.json.tests.TestObject("Hello there.", 7, testDate);
		try {
